...
import com.westerndigital.keyinsight.SpringEmail.SpringEmailSender;
import com.westerndigital.keyinsight.SpringEmail.SpringEmailService;
...
public class LoadDatabase implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                int randome = issueRepository.unfinishedJiraIssuesByToday("B8X4");
                System.out.print(randome);
                springEmailService.sendNotificationUnfinished(to, randome, name, projectName);
        ...
        //         .orElse(new JiraIssue()); // finds an issue in the database with that
        //         //issueNumber
        //         // if it doesn't exist, create a new Java Issue Object

        //         // Only needs to run on the FIRST iteration, we need to grab all the fields
        //        // that
        ...
        //         Instant.ofEpochMilli(singleIssue.getCreationDate().getMillis());
        ...
        //         Instant.ofEpochMilli(singleIssue.getUpdateDate().getMillis());
        ...
        //         Instant dueInstant =
        //         Instant.ofEpochMilli(singleIssue.getDueDate().getMillis());
        ...
        //         String resolutionDateTimeString =
        //         singleIssue.getField(resolvedDateTimeField).getValue().toString();
        //         DateTimeFormatter formatter =
        //         DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
        //         resolutionDateTime =
        //         OffsetDateTime.parse(resolutionDateTimeString,formatter);
        //         }
        //         //----------------------------------------------------------------------------

        //         // This block of code is grabbing the story points per issue if they have
        //       //  them
