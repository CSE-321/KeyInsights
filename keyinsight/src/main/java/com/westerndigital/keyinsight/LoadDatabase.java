        ...
        public void run(String... args) throws Exception {
                ...
                try {
                        ...
                        for (BasicProject basicProject : allProjects) {
                                ...
                                while (allIssuesCount > 0) {
                                        ...
                                        for (Issue singleIssue : allIssues) {
                                                ...
                                                JiraIssue issue = new JiraIssue(); // creates a Java Issue Object that
                                                                                   // allows us to store the
                                                                                   // Jira Issue information using the
                                                                                   // setters
                        ...
                        Float totalTeamTypeJiraIssueStoryPoint = issueRepository
                                        .totalTeamTypeJiraIssueStoryPoint(teamType)
                                        .orElse(0.0f);
                        // ----------------------------------------------------------------------------------------------------
                        ...
                        int totalTeamTypeJiraClosedIssueCount = issueRepository
                                        .totalTeamTypeJiraStatusIssueCount(teamType, closed);
                        ...
                        // -----------------------------------------------------------------------------------------------------------
                        int totalTeamTypeJiraWIPIssueCount = issueRepository.totalTeamTypeJiraStatusIssueCount(teamType,
                                        wip);
                        ...
                        int totalTeamTypeJiraBugIssueCount = issueRepository
                                        .totalTeamTypeJiraSubTypeIssueCount(teamType, bug);
                        // -----------------------------------------------------------------------------------------------------------
                        ...
                        int totalTeamTypeJiraCriticalNotCompletedIssueCount = issueRepository
                                        .totalTeamTypeJiraPriorityOppositeResolutionIssueCount(teamType,
                        ...
                        int totalTeamTypeJiraCancelledIssueCount = issueRepository
                                        .totalTeamTypeJiraResolutionIssueCount(teamType,
                                                        cancelled);
                        // -----------------------------------------------------------------------------------------------------------

                        System.out.println("The query for totalTeamTypeJiraIssueCount returns: "
                                        + totalTeamTypeJiraIssueCount);
                        System.out.println(
                                        "The query for totalTeamTypeJiraIssueStoryPoint returns: "
                                                        + totalTeamTypeJiraIssueStoryPoint);

                        System.out.println(
                                        "The query for totalTeamTypeJiraClosedIssueCount returns: "
                                                        + totalTeamTypeJiraClosedIssueCount);
                        ...
                        System.out.println(
                                        "The percentage between totalTeamTypeJiraClosedIssueCount and totalTeamTypeJiraIssueStoryPoint is "
                                                        + (totalTeamTypeJiraClosedIssueStoryPoint
                                                                        / totalTeamTypeJiraIssueStoryPoint) * 100.0f
                                                        + "%");

                        System.out
                                        .println("The query for totalTeamTypeJiraWIPIssueCount returns: "
                                                        + totalTeamTypeJiraWIPIssueCount);
                        ...
                        System.out
                                        .println("The query for totalTeamTypeJiraBugIssueCount returns: "
                                                        + totalTeamTypeJiraBugIssueCount);
                        System.out.println(
                                        "The percentange between totalTeamTypeJiraBugIssueCount and totalTeamTypeJiraIssueCount is "
                                                        + ((float) totalTeamTypeJiraBugIssueCount
                                                                        / totalTeamTypeJiraIssueCount) * 100.0f
                                                        + "%");
                        ...
                        System.out.println(
                                        "The percentage between totalTeamTypeJiraReopenedIssueCount and totalTeamTypeJiraIssueCount is "
                                                        + ((float) totalTeamTypeJiraReopenedIssueCount
                                                                        / totalTeamTypeJiraIssueCount) * 100
                                                        + "%");
                        ...
                        System.out.println(
                                        "The percentage between totalTeamTypeJiraCriticalIssueCount and totalTeamTypeJiraIssueCount is "
                                                        + ((float) totalTeamTypeJiraCriticalIssueCount
                                                                        / totalTeamTypeJiraIssueCount) * 100
                                                        + "%");
                        ...
                        System.out.println(
                                        "The percentage between totalTeamTypeJiraCancelledIssueCount and totalTeamTypeJiraIssueCount is "
                                                        + ((float) totalTeamTypeJiraCancelledIssueCount
                                                                        / totalTeamTypeJiraIssueCount) * 100
                                                        + "%");
